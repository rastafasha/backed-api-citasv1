																							...
																							<table width="100%"
																								...
																								<tr>
																									<td class="title-36 a-center pb-15"
																										style="font-size:30px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
																										<multiline>
																											<strong>Su Perfil se ha Activado!</strong>
																										</multiline>
																									</td>
																								</tr>
																							</table>
																					...
																					<tr>
																						<td class="pb-50"
																							...
																							<table width="100%"
																								...
																								{{-- <tr>
																									<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																										<img src="https://aramayrangel.klyntic.com/QR/HC-AramayR-Clinica.png" width="150" height="150" editable="true" border="0" alt="" />
